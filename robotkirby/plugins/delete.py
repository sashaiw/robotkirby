...
top_group = component.with_slash_command(
    tanjun.slash_command_group("delete", "Delete your own data")
)


@top_group.with_command
@tanjun.as_slash_command(
    "all", "delete all of your data from all servers", default_to_ephemeral=True
)
async def delete_all(
    ctx: tanjun.abc.Context, db: Database = tanjun.inject(type=Database)
) -> None:
...
@top_group.with_command
@tanjun.as_slash_command(
    "server", "delete all of your data from this server", default_to_ephemeral=True
)
...
@tanjun.as_slash_command(
    "channel", "delete all of your data from a channel", default_to_ephemeral=True
)
...
@tanjun.as_slash_command(
    "topic",
    "delete all of your data containing a certain topic (fuzzy search, pretty aggressive)",
