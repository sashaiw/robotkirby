...
top_group = component.with_slash_command(
    tanjun.slash_command_group("opt", "Opt in or out")
)
...
async def optin(
    ...
    await ctx.respond("You have successfully opted in to data collection.")
...
async def optout(
    ...
    await ctx.respond("You have successfully opted out of data collection.")
