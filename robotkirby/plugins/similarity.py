...
async def similarity(
    ...
    comparison_member_messages = ''.join(db.get_messages(member=member.id, guild=ctx.guild_id))
    ...
    for member_id in top_members:
        ...
        vectors = vectorizer.fit_transform([comparison_member_messages, current_member_messages])
